...
%%APPLY YOUR PIIE TO BINARY CASE

%%BAYESIAN NETWORKS PAPER
%%\textbf{Fulcher, Isabel R.}, Shpitser, I. \& Tchetgen Tchetgen, E. J. (2018). Estimating network causal effects in a sexual and injection-drug use network. Journal of American Statistical Association: Case studies and applications (Under review). \\

%%\textbf{Fulcher, Isabel R.}, Shi, X., \& Tchetgen Tchetgen, E. J. (2018). Robust Estimation of Mediated Effects. Epidemiology (Under review). \\

%%Evans, Katherine, \textbf{Fulcher, I.}, \& Tchetgen Tchetgen, E. J. (2018). A coherent likelihood parametrization for doubly robust estimation of a causal effect with missing confounders. Biometrika (Under review). \\
